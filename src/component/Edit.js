...
export default function Edit(){
    ...
    return <div id="home">
        ...
        <div className='insertBlock'>
            EMAIL <input id='email' name='email' type='text' ref={emailRef} defaultValue={profile.email}/>
        </div>
        <div className='insertBlock'>
            NAME <input id='name' name='name' type='text' ref={nameRef} defaultValue={profile.nickname}/>
        </div>
        <div className='insertBlock'>
            PHONE <input id='phone' name='phone' type='text' ref={phoneRef} defaultValue={profile.phone}/>
        </div>
